...
function useGetProblems(setLoadingProblems: React.Dispatch<React.SetStateAction<boolean>>) {
	...
	useEffect(() => {
      ...
      const necessaryProblemDataOnly: DBProblem[]= []
      querySnapshot.forEach((doc) => {
        necessaryProblemDataOnly.push({id:doc.id, ...doc.data()} as DBProblem)
      });
      // console.log("necessaryProblemDataOnly", necessaryProblemDataOnly)
      setProblems(necessaryProblemDataOnly)
